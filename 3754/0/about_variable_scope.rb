# rubocop:disable Lint/MissingCopEnableDirective, Lint/UselessAssignment, Style/GlobalVars
...
class AboutVariableScope < Neo::Koan
  ...
  def test_block_variables_cannot_be_accessed_outside_scope
    2.times { method_variable = 0 }
    assert_equal nil, defined? method_variable
  end
  ...
  def test_class_variable
    (1..9).each { |name| Mouse.new(name.to_s) }
