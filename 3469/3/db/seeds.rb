...
restaurants = [
  { name: 'MacDonalds', address: '812 Broadway, New York, NY 10003, USA',
    short_description: mac_s, full_description: description_mac },
  { name: 'Hapines', address: '2049 Broadway, New York, NY 10023, USA',
    short_description: hapines_s, full_description: description_hapines }
]
