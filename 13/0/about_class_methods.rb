...
class AboutClassMethods < Neo::Koan
  ...
  def DogTheSecond.wag
    :class_level_wag
  end

  def test_since_classes_are_objects_you_can_define_singleton_methods_on_them_too
    assert_equal :class_level_wag, DogTheSecond.wag
  end

  def test_class_methods_are_independent_of_instance_methods
    fido = DogTheSecond.new
  ...
  SELF_INSIDE_CLASS_STATEMENT = class Dog
                                  self
                                end

  def test_self_while_inside_class_is_class_object_not_instance
    assert_equal true, Dog == SELF_INSIDE_CLASS_STATEMENT
  end

  # ------------------------------------------------------------------

  class Dog
    def self.class_method_from_dog
      :another_way_to_write_class_methods
    end
  end

  def test_you_can_use_self_instead_of_an_explicit_reference_to_dog
    assert_equal :another_way_to_write_class_methods, Dog.class_method_from_dog
  end
