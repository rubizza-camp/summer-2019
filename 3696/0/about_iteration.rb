...
class AboutIteration < Neo::Koan
  ...
  def test_find_locates_the_first_element_matching_a_criteria
    ...
    style_pleaser = proc { |item| item.size > 4 }
    assert_equal 'Clarence', array.find(style_pleaser)
  end
  ...
  def test_inject_will_blow_your_mind
    ...
    # Applies a function and aggregates every element into one with some base value
  end
  ...
  # To call GC after we execute what we want
end
