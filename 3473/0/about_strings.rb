# rubocop:disable Metrics/ClassLength, Style/StringLiterals
...
EOS
  ...
  # rubocop:enable Layout/IndentHeredoc, Naming/HeredocDelimiterNaming
...
# rubocop:enable Metrics/ClassLength, Style/StringLiterals
