...
class AboutIteration < Neo::Koan
  ...
  def test_use_curly_brace_blocks
    array = [1, 2, 3]
    sum = 0
  ...
  def break_workswitheach_style_iterations
  ...
  # :reek:TooManyStatements
  def test_collecttransformselements_ofan_array
    array = [1, 2, 3]
  ...
  def test_selectselectscertainitemsfrom_an_array
    array = [1, 2, 3, 4, 5, 6]
  ...
  def test_findlocatesthefirstelementmatching_a_criteria
  ...
  # :reek:TooManyStatements
  def test_all_iterationmethodsworkonanycollectionnot_just_arrays
