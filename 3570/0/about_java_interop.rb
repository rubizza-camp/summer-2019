...
class AboutJavaInterop < Neo::Koan
  ...
  def test_however_most_methods_returning_strings_return_ruby_strings # rubocop:disable Metrics/LineLength, Metrics/AbcSize
    java_array = java.util.ArrayList.new
  ...
  def test_some_ruby_objects_can_be_coerced_to_java # rubocop:disable Metrics/LineLength, Metrics/AbcSize
  ...
  def test_some_ruby_objects_are_not_coerced_to_what_you_might_expect # rubocop:disable Metrics/LineLength, Metrics/AbcSize
