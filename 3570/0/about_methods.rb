...
def my_global_method(first_argument, second_argument)
...
class AboutMethods < Neo::Koan
  ...
  def method_with_defaults(first_argument, second_argument = :default_value)
    [first_argument, second_argument]
  end
  ...
  def my_method_in_the_same_class(first_argument, second_argument)
    first_argument * second_argument
  end
