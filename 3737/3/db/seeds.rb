restaraunts = [
  { name: 'Kamyanitsa', description: 'The restaurant “Kamyanitsa” can be safely called one
  ...
  { name: 'Chekhov',
    description: 'Cafe-living room “Chekhov” is a cafe in which you can also have a good rest. Here people communicate, play billiards, smoke together and play the piano, play solitaires and play chess. In a word, if you have nothing to do in the evening, you will like Chekhov. There are several rooms here, and people gather in everyone who have something in common. You can, for example, play billiards, and then go with friends in the smoking room. It often hosts banquets and receptions.
