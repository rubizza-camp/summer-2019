...
def score(dice)
  ...
  (2..9).each do |val|
    sum += val * 100 * (arr[val] / 3) if (arr[val] % 3).zero?
  end
...
class AboutScoringProject < Neo::Koan
  ...
  def test_score_of_a_single_roll_of_five
  ...
  def test_score_of_single_numbers_are_zero
    assert_equal 0, score([2, 3, 4, 6])
  end

  def test_score_of_a_triple_ones
    assert_equal 1000, score([1, 1, 1])
  end

  def test_score_of_other_triples_is_hundred
