...
class AboutClasses < Neo::Koan
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    ...
    fido.a_name = 'Fido'
    assert_equal [:@a_name], fido.instance_variables
  end
  ...
  def test_you_can_politely_ask_for_instance_variable_values
    ...
    assert_equal 'Fido', fido.instance_variable_get('@a_name')
  end
  ...
  def test_you_can_rip_the_value_out_using_instance_eval
    ...
    assert_equal 'Fido', fido.instance_eval('@a_name') # string version
    assert_equal 'Fido', (fido.instance_eval { @a_name }) # block version
  end
