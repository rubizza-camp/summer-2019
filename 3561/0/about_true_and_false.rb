...
class AboutTrueAndFalse < Neo::Koan
  # :reek:UncommunicativeVariableName and :reek:ManualDispatch and :reek:ControlParameter
  ...
  # :reek:UncommunicativeVariableName and :reek:ManualDispatch and :reek:TooManyStatements
