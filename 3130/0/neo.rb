...
module Neo
  ...
  module Color
    ...
    # rubocop:disable Style/AccessModifierDeclarations, Style/EvalWithLocation
    COLORS.each do |color, value|
      module_eval "def #{color}(string); colorize(string, #{value}); end"
      module_function color
    end
    # rubocop:enable Style/AccessModifierDeclarations, Style/EvalWithLocation
  ...
  class Sensei
      ...
      if step.passed?
        ...
        if @pass_count > progress.last.to_i
          @observations << Color.green(
            "#{step.koan_file}##{step.name} has expanded your awareness."
          )
        end
      else
        @failed_test = step
    ...
    # rubocop:disable Layout/IndentHeredoc, Metrics/LineLength, Lint/Void,  Metrics/MethodLength
 ...
 ::::::::::::,               Neo Software Artisans              , ::::::::::::
  :,::::::::: ::::                                               :::::::::::::
   ,:::::::::::  ,:                                          ,,:::::::::::::,
    ...
    # rubocop:enable Layout/IndentHeredoc, Metrics/LineLength, Lint/Void,  Metrics/MethodLength
...
# rubocop:disable Style/EndBlock
END {
  Neo::Koan.command_line(ARGV)
  Neo::ThePath.new.walk
}
# rubocop:enable Style/EndBlock
