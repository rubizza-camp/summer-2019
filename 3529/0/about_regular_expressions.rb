...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # Mmm... Never. If there is no match, it returns ""
  end
  ...
  # Why?
  #
  # By default, a quantifier tells the engine to match as many instances
  # of its quantified token or subpattern as possible. This behavior is called greedy.
  ...
  #
  # Character classes ([...]) are optimized for matching one out of some set of
  # characters, and alternatives (x|y) allow for more general choices of varying lengths
