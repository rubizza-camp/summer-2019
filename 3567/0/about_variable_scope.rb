...
# rubocop:disable Style/GlobalVars, Style/StringLiterals, Style/EachForSimpleLoop

require File.expand_path(File.dirname(__FILE__) + '/neo')

# :reek:UncommunicativeVariableName and :reek:UncommunicativeMethodName and :reek:ClassVariable
