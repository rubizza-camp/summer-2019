...
def my_global_method(variable_a, variable_b)
  variable_a + variable_b
end

#:reek:TooManyStatements and :reek:UtilityFunction and :reek:TooManyMethods
class AboutMethods < Neo::Koan
  ...
  def method_with_defaults(variable_a, variable_b = :default_value)
    [variable_a, variable_b]
  end
  ...
  # ------------------------------------------------------------------
  def my_method_in_the_same_class(variable_a, variable_b)
    variable_a * variable_b
  end
