Restaurant.create(name: 'Vasilki', latitude: 53.923152, longitude: 27.607001,
...
Restaurant.create(name: 'Falcone', latitude: 53.902018, longitude: 27.542650,
...
Restaurant.create(name: 'Bistro de Luxe', latitude: 53.900804, longitude: 27.551246,
...
User.create(name: 'Aleks', email: 'mikitsik@gmail.com', password: '111111')
User.create(name: 'Bob', email: 'example@gmail.com', password: '111111')
Comment.create(mark: 5, annotation: 'Yay! It is cool restaurant. Recommend it!', user_id: 1,
               restaurant_id: 1)
Comment.create(mark: 4, annotation: 'Delicios! But staff are not much affable.', user_id: 2,
               restaurant_id: 1)
Comment.create(mark: 3, annotation: 'This place is not what I wating for!', user_id: 1,
               restaurant_id: 2)
Comment.create(mark: 2, annotation: 'Harmful!', user_id: 2,
               restaurant_id: 2)
