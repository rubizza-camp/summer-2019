...
class AboutJavaInterop < Neo::Koan
  ...
  def test_however_most_methods_returning_strings_return_ruby_strings_one
    java_array = java.util.ArrayList.new
    assert_equal __, java_array.toString
  end

  def test_however_most_methods_returning_strings_return_ruby_strings_two
    java_array = java.util.ArrayList.new
    assert_equal __, java_array.toString.is_a?(String)
  end

  def test_however_most_methods_returning_strings_return_ruby_strings_three
    java_array = java.util.ArrayList.new
    assert_equal __, java_array.toString.is_a?(java.lang.String)
  end

  def test_some_ruby_objects_can_be_coerced_to_java_one
    assert_equal __, 'ruby string'.to_java.class
    assert_equal __, 1.to_java.class
  end

  def test_some_ruby_objects_can_be_coerced_to_java_two
    assert_equal __, 9.32.to_java.class
    assert_equal __, false.to_java.class
  end

  def test_some_ruby_objects_are_not_coerced_to_what_you_might_expect_one
    assert_equal __, [].to_java.class == Java::JavaUtil::ArrayList
  end

  def test_some_ruby_objects_are_not_coerced_to_what_you_might_expect_two
