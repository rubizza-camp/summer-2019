...
# rubocop:disable Style/TrivialAccessors, Naming/ClassAndModuleCamelCase
# class describe class methods
# :reek:TooManyMethods
class AboutClassMethods < Neo::Koan
  ...
  def Dog_numer_two.wag
    :class_level_wag
  end

  def test_since_classes_are_objects_you_can_define_singleton_methods_on_them_too
    assert_equal :class_level_wag, Dog_numer_two.wag
  end

  def test_class_methods_are_independent_of_instance_methods
    fido = Dog_numer_two.new
...
# rubocop:enable Style/TrivialAccessors, Naming/ClassAndModuleCamelCase
