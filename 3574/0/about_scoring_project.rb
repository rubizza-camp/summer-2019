...
def score(dice)
  ...
  (2..6).each do |number|
    points += (100 * number) * (dice.count(number) / 3)
  end
  points
end
...
class AboutScoringProject < Neo::Koan
  ...
  def test_score_of_multiple_ones_and_fives_is_the_sum_of_individual_scores
    assert_equal 300, score([1, 5, 5, 1])
  end

  def test_score_of_single_s_all
  ...
  def test_score_of_other_triples_is_x
