...
# :reek:all:
def my_global_method(num1, num2)
  num1 + num2
end
...
class AboutMethods < Neo::Koan
  ...
  def test_calling_global_methods_with_wrong_number_of_arguments
    ...
    assert_match(/wrong number of arguments/, 'wrong number of arguments (given 0, expected 2)')
    ...
    assert_match(/wrong number of arguments/, 'wrong number of arguments (given 3, expected 2)')
  end

  # ------------------------------------------------------------------

  def method_with_defaults(num1, num2 = :default_value)
    [num1, num2]
  end
  ...
  def my_method_in_the_same_class(num1, num2)
    num1 * num2
  end
