...
# rubocop:disable Performance/RedundantSortBy, Metrics/CyclomaticComplexity
...
def triangle(a_side, b_side, c_side)
  ...
  raise TriangleError if a_side.zero?
...
# rubocop:enable Performance/RedundantSortBy, Metrics/CyclomaticComplexity
